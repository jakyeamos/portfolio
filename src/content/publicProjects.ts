...
import { PUBLIC_COURT_PROJECT_SLUGS, PUBLIC_PROJECT_SLUGS } from '@/content/publicProjectManifest';
...
export const PUBLIC_COURT_PROJECTS: readonly CurrentProject[] = PUBLIC_PROJECTS.filter((project) =>
  PUBLIC_COURT_PROJECT_SLUGS.includes(project.slug),
);
