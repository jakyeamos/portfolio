...
- The recruiter-facing quick links now include the personal X profile at `https://x.com/soundscapeweb`; the existing portfolio writer remains the canonical Markdown handoff for the portfolio and FRMWRK Labs and emits a review payload for Career-Ops.
